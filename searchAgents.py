...
def nullHeuristic(position, problem, info={}):
...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self._visited, self._visitedlist, self._expanded = {}, [], 0 # Number of search nodes expanded
    ...
    def isGoalState(self, state):
        ...
        isGoal = cornersVisited[0] and cornersVisited[1] and cornersVisited[2] and cornersVisited[3]
    ...
    def getSuccessors(self, state):
        ...
        successors = []
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            cornersVisited = copy.deepcopy(state[1])
            x,y = state[0]
            dx, dy = Actions.directionToVector(action)
            nextx, nexty = int(x + dx), int(y + dy)
            if not self.walls[nextx][nexty]:
...
class CornersFoodProblem(CornersProblem):
    """
    This search problem finds paths through all four corners of a layout.
    ...
    def __init__(self, startingGameState, corners):
        """
        Stores the walls, pacman's starting position and corners.
        """
        self.walls = startingGameState.getWalls()
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        return search.aStarSearch(problem, nullHeuristic)
